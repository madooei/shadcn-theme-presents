...
import { Card, CardContent, CardHeader, CardTitle } from "@madooei/shadcn-all-in-one/card";
import { type ChartConfig, ChartContainer } from "@madooei/shadcn-all-in-one/chart";
